...
?><!DOCTYPE HTML><html>
	<head>
		...
		<link rel="shortcut icon" href="http://static.iaibai.com/assets/production/favicon.png" />
		<link rel="apple-touch-icon" href="http://static.iaibai.com/assets/production/apple-touch-icon.png"/>
		<?php
		if ( $mobileDevice )
		{
			?>
		...
		<style>
			...
			body
			{
				...
				background: #333 url(http://static.iaibai.com/assets/production/bg.png);
			}
	...
	<body onload="init()">
		...
		<div id="container">
			...
			<div id="header">
				<img src="http://static.iaibai.com/assets/production/avatar.png" style="float:right">
				<h1>Iain's<br>Site</h1>
			</div>

            <div class="article">
                <h2>Push on Feedback</h2>
                <p>We're so keen on feedback that we now have 2 feedback forms.</p>

                <script type="text/javascript">
                    !function(e,t,r,n,a){if(!e[a]){for(var i=e[a]=[],s=0;s<r.length;s++){var c=r[s];i[c]=i[c]||function(e){return function(){var t=Array.prototype.slice.call(arguments);i.push([e,t])}}(c)}i.SNIPPET_VERSION="1.0.1";var o=t.createElement("script");o.type="text/javascript",o.async=!0,o.src="https://d2yyd1h5u9mauk.cloudfront.net/integrations/web/v1/library/"+n+"/"+a+".js";var l=t.getElementsByTagName("script")[0];l.parentNode.insertBefore(o,l)}}(window,document,["survey","reset","config","init","set","get","event","identify","track","page","screen","group","alias"],"dskVByY3GMMWzlTa","delighted");
                    delighted.survey();
                </script>
            </div>
